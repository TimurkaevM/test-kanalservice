...
const Header = ({ navigate }) => {
  ...
  return (
    <View style={styles.header}>
      <Image source={width > 500 ? mediumLogo : smallLogo} />
      {isAuth ? (
        <TouchableOpacity style={styles.btn} title="logOut" onPress={goOut}>
          <Svg
            width="62"
            height="56"
            viewBox="0 0 62 56"
            ...
            <Path
              d="M61.4036 26.6281L47.3488 15.0341C47.1078 14.8354 46.8841 14.7301 46.6242 14.7301C46.0603 14.7301 45.5306 15.2345 45.5306 16.1985V23.0899H27.5291C26.6828 23.0899 25.92 23.9266 25.92 24.923V30.8963C25.92 31.8928 26.683 32.7274 27.5291 32.7274H45.5306V39.6225C45.5306 40.5864 46.0606 41.1602 46.6246 41.1602C46.6247 41.1602 46.6043 41.1602 46.6043 41.1602C46.8642 41.1602 47.1189 41.0205 47.3597 40.8215L61.4084 29.2111C61.7858 28.8999 61.9996 28.4237 61.9998 27.9197C62 27.4159 61.7812 26.9395 61.4036 26.6281Z"
              fill={colors.BLUE}
            />
            <Path
